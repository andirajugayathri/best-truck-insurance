...
ini_set('error_log', __DIR__ . '/box_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    : '';
    $coverageOptions = substr($coverageOptions, 0, 120);
    return [
        ...
        'Product_Inquiry' => 'box Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New box Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New box Truck Insurance Quote</h2>
    ...
    $headers .= "From: box Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
