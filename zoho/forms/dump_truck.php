...
ini_set('error_log', __DIR__ . '/dump_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Dump Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Dump Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Dump Truck Insurance Quote</h2>
    ...
    $headers .= "From: Dump Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
