...
ini_set('error_log', __DIR__ . '/fleet_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Fleet Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Fleet Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Fleet Truck Insurance Quote</h2>
    ...
    $headers .= "From: Fleet Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
