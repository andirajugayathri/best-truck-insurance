...
ini_set('error_log', __DIR__ . '/food_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Food Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Food Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Food Truck Insurance Quote</h2>
    ...
    $headers .= "From: Food Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
