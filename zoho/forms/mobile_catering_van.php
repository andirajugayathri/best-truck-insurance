...
ini_set('error_log', __DIR__ . '/mobile_catering_van_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry'                               => 'Mobile Catering Van Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Mobile Catering Van Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Mobile Catering Van Insurance Quote</h2>
    <table border='1' cellpadding='10' cellspacing='0'>
        ...
        <tr><th>Van/Equipment Value</th><td>{$safe($data['Sum_Insured'])}</td></tr>
    ...
    $headers .= "From: Mobile Catering Van Insurance <mail@besttruckinsurance.com.au>\r\n";
