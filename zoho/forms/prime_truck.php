...
ini_set('error_log', __DIR__ . '/prime_mover_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Prime Mover Truck Insurance',
...
{
    try {
        $sql = "INSERT INTO prime_mover_truck (
            full_name,
            company_name,
            contact_number,
            email,
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Prime Mover Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Prime Mover Truck Insurance Quote</h2>
    ...
    $headers .= "From: Prime Mover Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
