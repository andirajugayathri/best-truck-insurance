...
ini_set('error_log', __DIR__ . '/tipper_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Tipper Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Tipper Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Tipper Truck Insurance Quote</h2>
    ...
    $headers .= "From: Tipper Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
