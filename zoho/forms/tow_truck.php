...
ini_set('error_log', __DIR__ . '/tow_truck_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Tow Truck Insurance',
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Tow Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Tow Truck Insurance Quote</h2>
    ...
    $headers .= "From: Tow Truck Insurance <mail@besttruckinsurance.com.au>\r\n";
