...
ini_set('error_log', __DIR__ . '/tractor_trailer_error.log');
...
function mapFormFields($formData)
{
    ...
    return [
        ...
        'Product_Inquiry' => 'Tractor Trailer Truck Insurance',
...
{
    try {
        // Using common truck insurance table if available, or creating/mapping to appropriate one.
        // For now, mapping to a generic tractor_trailer table.
        $sql = "INSERT INTO tractor_trailer (
            full_name,
            company_name,
            contact_number,
            email,
...
function sendNotificationEmail($data)
{
    ...
    $subject = "New Tractor Trailer Truck Insurance Quote Request";

    $message = "
    <html><body>
    <h2>New Tractor Trailer Truck Insurance Quote</h2>
    <table border='1' cellpadding='10' cellspacing='0'>
        ...
        <tr><th>Value of Truck & Trailer</th><td>{$safe($data['Sum_Insured'])}</td></tr>
    ...
    $headers .= "From: Tractor Trailer Insurance <mail@besttruckinsurance.com.au>\r\n";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Try to insert data, but continue if table doesn't exist (DB not strictly required for Zoho/Email)
    insertDataIntoDatabase($mappedData, $pdo);
